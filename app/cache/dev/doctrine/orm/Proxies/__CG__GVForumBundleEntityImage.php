 ...
 */
class Image extends \GV\ForumBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GV\\ForumBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'GV\\ForumBundle\\Entity\\Image' . "\0" . 'updateAt', 'name', 'path', 'file');
        }

        return array('__isInitialized__', '' . "\0" . 'GV\\ForumBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'GV\\ForumBundle\\Entity\\Image' . "\0" . 'updateAt', 'file');
    }
