 ...
 */
class Video extends \GV\ForumBundle\Entity\Video implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GV\\ForumBundle\\Entity\\Video' . "\0" . 'id', '' . "\0" . 'GV\\ForumBundle\\Entity\\Video' . "\0" . 'updateAt', 'name', 'path', 'file');
        }

        return array('__isInitialized__', '' . "\0" . 'GV\\ForumBundle\\Entity\\Video' . "\0" . 'id', '' . "\0" . 'GV\\ForumBundle\\Entity\\Video' . "\0" . 'updateAt', 'file');
    }
